...
router.get("/all-blogs", blog_controller_1.BlogController.allBlogs);
router.put("/:id", (0, checkAuth_1.checkAuth)(envConfig_1.envVariables.ADMIN_EMAIL), multer_1.upload.single("file"), blog_controller_1.BlogController.createBlog);
